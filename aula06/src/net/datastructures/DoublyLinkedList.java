...
public class DoublyLinkedList<E> {
  ...
  public void addAtIndex(E e, int idx) {
	  NodeDouble<E> walk = header.getNext();
	  int pos = -1;
	  // TODO: retorno de erro se idx > size+1
	  if (idx > size) {
		  throw new IndexOutOfBoundsException();
	  }
	  // TODO: adicao ao final da lista
	  if (idx == size) {
		  addLast(e);
		  return;
	  }
  ...
  public void addInOrder(E e) {
	  NodeDouble<E> walk = header.getNext();
	  int eConvertido = (int) e;
	  int eWalkConvertido;
	  while (walk != trailer) {
		  eWalkConvertido = (int) walk.getElement();
		  if (eConvertido < eWalkConvertido) {
			  addBetween(e, walk.getPrev(), walk);
			  return;
		  }
		  walk = walk.getNext();
  ...
  public void percorrerListaCrescente() {
	    NodeDouble<E> walk = header.getNext();
	    while (walk != trailer) {
  ...
  public void percorrerListaDecrescente() {
	    NodeDouble<E> walk = trailer.getPrev();
	    while (walk != header) {
	    	System.out.println(walk.getElement());
	    	walk = walk.getPrev();
	    }
  ...
  public void addPosicao(E e, int indice) {
	    addBetween(e, trailer.getPrev(), trailer);  // place just before the trailer
	  }
